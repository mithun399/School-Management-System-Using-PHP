    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/3.jpg" alt="Sanmar" width="1100" height="500">
            ...
            <div class="carousel-item">
                <img src="img/1.jpg" alt="Equity" width="1100" height="500">
            ...
            <div class="carousel-item">
                <img src="img/2.jpg" alt="jpg" width="1100" height="500">
                <div class="carousel-caption">
                    <h3>School Management System</h3>
                    <p>A school is an educational institution designed to provide learning spaces and learning
                        environments for the teaching of students</p>
    ...
    <div class="content templete clear">
        ...
        <div class="midcontent">
            ...
            <div>
                ...
                <p>
                    <img src="img/signature.jpg" alt="Headmaster signecher" width="15%" /><br />
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="img/Head.jpg" alt="Card image">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="img/a.jpg" alt="Card image">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="img/b.jpg" alt="Card image">
                        <div class="card-body">
