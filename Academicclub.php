...
<head>
    ...
    <link rel="stylesheet" href="css/Academic_Club.css">
...
<body>
    ...
    <section>
                <div class="col-sm-12 col-md-6 col-lg-12">
                    <img src="img/Club.jpg" alt="Club" class="img">
                    <div class="bg_font">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5 m-2" style="width: 18rem;">
                    <img src="img/Computer.png" class="card-img-top" alt="Computer Club">
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5 m-2" style="width: 18rem;">
                    <img src="img/Debate.png" class="card-img-top" alt="Debating Club">
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5" style="width: 18rem;">
                    <img src="img/Sport.png" class="card-img-top" alt="Sports Club">
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5" style="width: 18rem;">
                    <img src="img/Science.jpg" class="card-img-top" alt="Science Club">
                    <div class="card-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-3 mb-3">
                <div class="card mt-5" style="width: 18rem;">
                    <img src="img/Culture.jpg" class="card-img-top" alt="Culture Club">
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5" style="width: 18rem;">
                    <img src="img/Business.png" class="card-img-top" alt="Business Club">
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5" style="width: 18rem;">
                    <img src="img/Language.jpg" class="card-img-top" alt="Language Club">
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="card mt-5" style="width: 18rem;">
                    <img src="img/Charity.jpg" class="card-img-top" alt="Charity Club">
                    <div class="card-body">
