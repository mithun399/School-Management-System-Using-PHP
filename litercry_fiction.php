...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="css/literery.css">
...
<div class="container">
  ...
  <div class="card">
    <img class="card-img-top" src="img/l3.jpg" alt="Card image cap">
    <div class="card-body">
...
<div class="card-deck mt-4">
  <div class="card">
    <img class="card-img-top" src="img/l4.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="img/l5.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="img/l6.jpg" alt="Card image cap">
    <div class="card-body">
